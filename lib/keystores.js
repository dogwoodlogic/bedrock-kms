...
/* FIXME:
1. Add API for updating keystore usage. Write updates to in-memory cache and
...
2. Add API call to get latest usage limitations associated with a keystore
  using a zcap stored with the keystore config. Fetch and apply those
  limitations on request; ensure memoized promise is used to reduce database
...
bedrock.events.on('bedrock-mongodb.ready', async () => {
  await database.openCollections(['kmsKeystore']);
